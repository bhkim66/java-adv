...
public class NewOrderService {
    ...
    public void order(String orderNo){
        ...
        Future<String> future1 = es.submit(new InventoryWork(orderNo));
        Future<String> future2 = es.submit(new ShippingWork(orderNo));
        Future<String> future3 = es.submit(new AccountingWork(orderNo));
